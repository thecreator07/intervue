...
export interface SummaryEvaluation extends Document {
...
const SummaryEvaluationSchema = new Schema<SummaryEvaluation>({
...
const EvaluationModel =
  ...
  mongoose.model<SummaryEvaluation>("Evaluation", SummaryEvaluationSchema);
